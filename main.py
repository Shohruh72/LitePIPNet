...
def train(args, params):
    model = nn.PIPNet(params, args.model_name, True,
...
def demo(params):
    ...
    model = torch.load('./outputs/weights/best.pt', 'cpu')['model'].float()
    model = nn.re_parameterize_model(model)
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='../Datasets/LMK/images')
